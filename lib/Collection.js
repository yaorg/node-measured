...
/**
 * A Simple collection that stores names and a {@link Metric} implementation with a few convenience methods for
...
class Collection {
   ...
   * @param name The metric name
   * @param requestedType The metric type
